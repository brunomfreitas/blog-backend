...
INSERT INTO blog.post (id, title, subtitle, message, image, createdat, createdby, postedat, postedby, category, post_status) VALUES
(4, 'A Revolução Industrial e a transformação da sociedade moderna', 'Conheça as mudanças econômicas, sociais e tecnológicas provocadas pela Revolução Industrial', 'A Revolução Industrial foi um dos processos históricos mais importantes da humanidade, iniciando profundas transformações na forma de produzir, trabalhar e viver em sociedade. Surgida no século XVIII, principalmente na Inglaterra, ela marcou a substituição do trabalho artesanal pelo uso de máquinas e pela produção em larga escala.
